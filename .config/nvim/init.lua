...
function configure_lsp()
	local lsp_attach_cb = function(event)
		...
		map("<leader>dw", require("telescope.builtin").lsp_dynamic_workspace_symbols,
			"[W]orkspace [S]ymbols")
		...
		map("<leader>vwr", vim.lsp.buf.remove_workspace_folder,
...
function configure_treesitter()
	require("nvim-treesitter.configs").setup({
		ensure_installed = { "c", "cpp", "go", "lua", "python", "rust", "tsx", "typescript", "vimdoc", "markdown", "vim" },
		auto_install = true,
