...
local function configure_keymaps()
    ...
    vim.keymap.set("n", "<C-Down>", "<Cmd>MultipleCursorsAddDown<CR>")
    vim.keymap.set("n", "<C-j>", "<Cmd>MultipleCursorsAddDown<CR>")
    vim.keymap.set("n", "<C-Up>", "<Cmd>MultipleCursorsAddUp<CR>")
    vim.keymap.set("n", "<C-k>", "<Cmd>MultipleCursorsAddUp<CR>")
    vim.keymap.set("n", "<C-LeftMouse>", "<Cmd>MultipleCursorsMouseAddDelete<CR>")
    vim.keymap.set("n", "<Leader>a", "<Cmd>MultipleCursorsAddMatches<CR>")
    vim.keymap.set("n", "<Leader>A", "<Cmd>MultipleCursorsAddMatchesV<CR>")
    vim.keymap.set("n", "<Leader>d", "<Cmd>MultipleCursorsAddJumpNextMatch<CR>")
    vim.keymap.set("n", "<Leader>D", "<Cmd>MultipleCursorsJumpNextMatch<CR>")
    vim.keymap.set("n", "<Leader>l", "<Cmd>MultipleCursorsLockToggle<CR>")
